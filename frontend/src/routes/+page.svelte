...
<div class="container min-h-[100vh] min-w-full bg-slate-100 py-8">
	<div class="prose mx-auto max-h-full rounded-xl bg-white p-8 shadow-lg">
		<h1>{title}</h1>
